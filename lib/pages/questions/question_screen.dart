...
class QuestionEnadeScreen extends StatefulWidget {
  _QuestionEnadeScreen createState() => _QuestionEnadeScreen();
}

class _QuestionEnadeScreen extends State<QuestionEnadeScreen> {
  ...
  _buildChartAnswer(Question question) {
    ...
    return Observer(
        builder: (_) => answerController.loadingSearchAnswers
            ...
            : Expanded(child: PieChart(answerController.listAnswers)));
  }
}
